...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        # inputs['left'], inputs['right'], deadline
    ...
    def createQ(self, state):
        ...
        if self.learning:
            if not self.Q.has_key(state):
                ...
                possible_pairs = dict(zip(possible_actions,[0.0]*len(possible_actions)))
                self.Q[state] = possible_pairs
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, epsilon=1, alpha=0.003)
    ...
    sim.run(tolerance=0.0022, n_test=100)
